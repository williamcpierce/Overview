        ...
        Form {
            ...
            Section {
                ...
                HStack {
                    Text("Width")
                    Spacer()
                    TextField("", value: $appSettings.windowDefaultWidth, formatter: NumberFormatter())
                        .frame(width: 120)
                ...
                HStack {
                    Text("Height")
                    Spacer()
                    TextField("", value: $appSettings.windowDefaultHeight, formatter: NumberFormatter())
                        .frame(width: 120)
                        .textFieldStyle(.roundedBorder)
                    Text("px")
                        .foregroundColor(.secondary)
            ...
            Section {
                ...
                Toggle("Hide previews for inactive applications", isOn: $appSettings.previewHideInactiveApplications)
