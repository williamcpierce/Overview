/*
 Window/Settings/LayoutSettingsTab.swift
 Overview
...
struct LayoutSettingsTab: View {
    ...
    // Selected layout dropdown state
    ...
    var body: some View {
        Form {
            Section {
                ...
                // Simplified dropdown for apply layout on launch
                HStack {
        ...
        .formStyle(.grouped)
        .onAppear {
            // Initialize the selected layout when the view appears
